Example anonymous dataset. Please notify me if any problems arise. A few notes about this dataset: 
  ...
  - Data structure:
    ...
    - subX_MEG_preprocessed_sensor - MEG dataset (runs combined) in Fieldtrip format after all preprocessing steps. This dataset is ready to be read into the main dRSA analysis script 
