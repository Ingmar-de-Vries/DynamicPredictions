...
The code is structured as follows:
  ...
  - Run dRSA analysis, statistics, plotting, and simulations
    - In the "dynamicRSA" subdirectory, you'll find the following scripts:
      ...
      - "regressionBorderPerModel_smRDM20msec.mat" - data with regression borders used to regress out model itself to attenuate effects of model autocorrelation. These borders are determined by the simulations (see methods section in article). 
