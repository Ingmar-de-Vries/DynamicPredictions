...
The code is structured as follows:
  ...
  - Run dRSA analysis, statistics, plotting, and simulations
    - In the "dynamicRSA" subdirectory, you'll find the following scripts:
      ...
      - "DynamicPredictions_STATS_ERFdynamicRSA_ROIsource.m" - run statistics on ROI-based dRSA results, and compute peak latency and representational spread (RS) index.
